...
<body style="background-image: url('assets/img/masyarakat2.jpg'); background-size:cover" >
...
<footer class="footer mt-3 py-2" style="background-color: grey;">
    <div class="container">
        <p class="text-center">UKK RPL 2023 | HAIKAL | SMK 1 KARAWANG</p>
</div>
</footer>
